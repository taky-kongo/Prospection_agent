...
export function CampaignTableSkeleton() {
  return (
    <div className="w-full rounded-lg border border-stone-200 shadow-sm bg-white p-0">
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow className="border-b-stone-200 hover:bg-transparent">
          ...
          <TableBody>
            {Array.from({ length: 10 }).map((_, rowIndex) => (
              <TableRow key={rowIndex} className="border-b-stone-200">
